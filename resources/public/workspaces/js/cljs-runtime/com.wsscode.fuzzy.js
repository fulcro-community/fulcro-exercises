 ...
 *   ```
 */
com.wsscode.fuzzy.match_one = (function com$wsscode$fuzzy$match_one(p__69114,p__69115){
var map__69116 = p__69114;
var map__69116__$1 = (((((!((map__69116 == null))))?(((((map__69116.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69116.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69116):map__69116);
var search_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69116__$1,new cljs.core.Keyword("com.wsscode.fuzzy","search-input","com.wsscode.fuzzy/search-input",897823168));
var map__69118 = p__69115;
var map__69118__$1 = (((((!((map__69118 == null))))?(((((map__69118.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69118.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69118):map__69118);
var opt = map__69118__$1;
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69118__$1,new cljs.core.Keyword("com.wsscode.fuzzy","string","com.wsscode.fuzzy/string",320074815));
var vec__69121 = com.wsscode.fuzzyjs.fuzzy_match(search_input,string);
var match_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69121,(0),null);
var score = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69121,(1),null);
var hl = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69121,(2),null);
 ...
 */
com.wsscode.fuzzy.fuzzy_match = (function com$wsscode$fuzzy$fuzzy_match(p__69127){
var map__69128 = p__69127;
var map__69128__$1 = (((((!((map__69128 == null))))?(((((map__69128.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69128.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__69128):map__69128);
var input = map__69128__$1;
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69128__$1,new cljs.core.Keyword("com.wsscode.fuzzy","options","com.wsscode.fuzzy/options",773495630));
var search_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__69128__$1,new cljs.core.Keyword("com.wsscode.fuzzy","search-input","com.wsscode.fuzzy/search-input",897823168));
var sort_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__69128__$1,new cljs.core.Keyword("com.wsscode.fuzzy","sort?","com.wsscode.fuzzy/sort?",1163052809),true);
if(cljs.core.seq(search_input)){
var fuzzy = cljs.core.partial.cljs$core$IFn$_invoke$arity$2(com.wsscode.fuzzy.match_one,input);
var compare = (function (p1__69126_SHARP_,p2__69125_SHARP_){
return cljs.core.compare(p2__69125_SHARP_,p1__69126_SHARP_);
});
var _LT__GT_ = options;
var _LT__GT___$1 = cljs.core.keep.cljs$core$IFn$_invoke$arity$2(fuzzy,_LT__GT_);
var G__69132 = _LT__GT___$1;
if(cljs.core.truth_(sort_QMARK_)){
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("com.wsscode.fuzzy","match-score","com.wsscode.fuzzy/match-score",-1700262252),compare,G__69132);
} else {
return G__69132;
}
} else {
