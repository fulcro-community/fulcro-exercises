...
hljs.inherit(VALUE_CONTAINER,{begin:/:/})].concat(ALLOWED_COMMENTS),illegal:"\\S"};hljs={begin:"\\[",end:"\\]",contains:[hljs.inherit(VALUE_CONTAINER)],illegal:"\\S"};TYPES.push(OBJECT,hljs);ALLOWED_COMMENTS.forEach(function(rule){TYPES.push(rule)});return{contains:TYPES,keywords:LITERALS,illegal:"\\S"}}}
