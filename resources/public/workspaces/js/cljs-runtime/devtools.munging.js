...
var o48608 = temp__5751__auto__;
var temp__5751__auto____$1 = (o48608["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o48609 = temp__5751__auto____$1;
return (o48609["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__47935__auto__ = f;
return (o__47935__auto__["toString"]).call(o__47935__auto__);
} else {
return "";
}
...
try{var o__47935__auto___48842 = t;
(o__47935__auto___48842["cljs$lang$ctorPrWriter"]).call(o__47935__auto___48842,t,writer);
}catch (e48619){var __48843 = e48619;
}
...
var char_code = (function (){var o__47935__auto__ = (new String(char$));
return (o__47935__auto__["charCodeAt"]).call(o__47935__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__47935__auto__ = String;
return (o__47935__auto__["fromCharCode"]).call(o__47935__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__48624 = num_code;
switch (G__48624) {
case (1):
return (185);
...
var o__47935__auto__ = String;
return (o__47935__auto__["fromCharCode"]).call(o__47935__auto__,superscript_code);
});
/**
...
}catch (e48637){var _e__47959__auto__ = e48637;
return false;
}})())){
...
var vec__48638 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48638,(0),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var o48646 = temp__5751__auto__;
var temp__5751__auto____$1 = (o48646["dependencies_"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o48647 = temp__5751__auto____$1;
return (o48647["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__48653){
var vec__48656 = p__48653;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48656,(0),null);
...
var G__48866 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__48867 = cljs.core.butlast(remaining_tokens);
name_tokens = G__48866;
remaining_tokens = G__48867;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq48648){
var G__48650 = cljs.core.first(seq48648);
var seq48648__$1 = cljs.core.next(seq48648);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48650,seq48648__$1);
}));
...
var vec__48698 = cljs.core.split_with((function (p1__48696_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48696_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48698,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48698,(1),null);
...
var vec__48713 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48713,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48713,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__48873 = cljs.core.rest(remaining_tokens);
var G__48874 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__48873;
name_tokens = G__48874;
continue;
} else {
...
var vec__48719 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48719,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48719,(1),null);
var vec__48722 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48722,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48722,(1),null);
var vec__48725 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48725,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48725,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48725,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48725,(3),null);
...
var vec__48735 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48735,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48735,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48735,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48735,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48735,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48735,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__48738 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48738,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48738,(1),null);
var vec__48742 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48742,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48742,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__48745 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__48745) : devtools.munging.parse_fn_info_deep.call(null,G__48745));
})()));
}
} else {
return fn_info;
...
var G__48890 = (arity + (1));
var G__48891 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__48757){
var vec__48758 = p__48757;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48758,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48758,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48764_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__48764_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48765_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__48765_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__48776){
var vec__48777 = p__48776;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48777,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq48772){
var G__48773 = cljs.core.first(seq48772);
var seq48772__$1 = cljs.core.next(seq48772);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48773,seq48772__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48796__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48796__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48796__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48796__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__48797 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(5),null);
...
var o__47935__auto__ = f;
return (o__47935__auto__["getBasis"]).call(o__47935__auto__);
});
/**
...
}catch (e48805){var _e__47959__auto__ = e48805;
...
var G__48910 = (obj[cljs.core.first(path)]);
var G__48911 = cljs.core.rest(path);
obj = G__48910;
path = G__48911;
continue;
} else {
...
var _STAR_ = (function (accum,p__48820){
var vec__48821 = p__48820;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48821,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48821,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__48830){
var vec__48831 = p__48830;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48831,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48831,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48831,(2),null);
...
var post_process = (function (p__48836){
var vec__48837 = p__48836;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48837,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48837,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48835_SHARP_){
return (obj[cljs.core.first(p1__48835_SHARP_)]);
}),sorted_matches);
