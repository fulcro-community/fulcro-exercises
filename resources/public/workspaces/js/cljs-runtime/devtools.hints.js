...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48605__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48605__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48605__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e48604){var _e = e48604;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___48632 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___48632)){
var seen_errors_48633 = temp__5751__auto___48632;
if(cljs.core.truth_(seen_errors_48633.has(self))){
} else {
seen_errors_48633.add(self);

var temp__5753__auto___48634 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___48634)){
var sense_48635 = temp__5753__auto___48634;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_48635)].join(''));
} else {
}
}
} else {
