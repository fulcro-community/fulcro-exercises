...
var len__4736__auto___50093 = arguments.length;
var i__4737__auto___50094 = (0);
while(true){
if((i__4737__auto___50094 < len__4736__auto___50093)){
args__4742__auto__.push((arguments[i__4737__auto___50094]));

var G__50095 = (i__4737__auto___50094 + (1));
i__4737__auto___50094 = G__50095;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__49992_50096 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__49993_50097 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__49994_50098 = true;
var _STAR_print_fn_STAR__temp_val__49995_50099 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__49994_50098);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__49995_50099);

try{var _STAR_print_level_STAR__orig_val__49997_50103 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__49998_50104 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__49998_50104);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__49997_50103);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__49993_50097);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__49992_50096);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq49990){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49990));
}));
...
var new_formatters = current_formatters.filter((function (p1__50035_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__50035_SHARP_)));
}));
...
var G__50042_50140 = f;
var target__47952__auto___50141 = G__50042_50140;
if(cljs.core.truth_(target__47952__auto___50141)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50042_50140)].join(''),"\n","target__47952__auto__"].join('')));
}

(target__47952__auto___50141["toString"] = (function (){
...
var G__50046_50143 = "%c%s";
var G__50047_50144 = "color:transparent";
var G__50048_50145 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__50046_50143,G__50047_50144,G__50048_50145) : f.call(null,G__50046_50143,G__50047_50144,G__50048_50145));
...
var args__4742__auto__ = [];
var len__4736__auto___50146 = arguments.length;
var i__4737__auto___50147 = (0);
while(true){
if((i__4737__auto___50147 < len__4736__auto___50146)){
args__4742__auto__.push((arguments[i__4737__auto___50147]));

var G__50148 = (i__4737__auto___50147 + (1));
i__4737__auto___50147 = G__50148;
continue;
} else {
}
break;
...
var vec__50065 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50065,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50065,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__50149__delegate = function (add_fmt,add_args){
...
var G__50149 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__50154__i = 0, G__50154__a = new Array(arguments.length -  1);
while (G__50154__i < G__50154__a.length) {G__50154__a[G__50154__i] = arguments[G__50154__i + 1]; ++G__50154__i;}
  add_args = new cljs.core.IndexedSeq(G__50154__a,0,null);
} 
return G__50149__delegate.call(this,add_fmt,add_args);};
G__50149.cljs$lang$maxFixedArity = 1;
G__50149.cljs$lang$applyTo = (function (arglist__50155){
var add_fmt = cljs.core.first(arglist__50155);
var add_args = cljs.core.rest(arglist__50155);
return G__50149__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq50058){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50059,G__50060,G__50061,seq50058__$3);
}));
...
var seq__50075 = cljs.core.seq(features);
var chunk__50076 = null;
var count__50077 = (0);
var i__50078 = (0);
while(true){
if((i__50078 < count__50077)){
var feature = chunk__50076.cljs$core$IIndexed$_nth$arity$2(null,i__50078);
...
var G__50161 = seq__50075;
var G__50162 = chunk__50076;
var G__50163 = count__50077;
var G__50164 = (i__50078 + (1));
seq__50075 = G__50161;
chunk__50076 = G__50162;
count__50077 = G__50163;
i__50078 = G__50164;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__50075);
if(temp__5753__auto__){
var seq__50075__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50075__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__50075__$1);
var G__50165 = cljs.core.chunk_rest(seq__50075__$1);
var G__50166 = c__4556__auto__;
var G__50167 = cljs.core.count(c__4556__auto__);
var G__50168 = (0);
seq__50075 = G__50165;
chunk__50076 = G__50166;
count__50077 = G__50167;
i__50078 = G__50168;
continue;
} else {
var feature = cljs.core.first(seq__50075__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__50171 = cljs.core.next(seq__50075__$1);
var G__50172 = null;
var G__50173 = (0);
var G__50174 = (0);
seq__50075 = G__50171;
chunk__50076 = G__50172;
count__50077 = G__50173;
i__50078 = G__50174;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o50086 = temp__5751__auto__;
return (o50086["version"]);
} else {
return null;
}
})() == null);
