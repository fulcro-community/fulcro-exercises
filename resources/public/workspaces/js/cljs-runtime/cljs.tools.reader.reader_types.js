...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_51435 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_51435(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_51441 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_51441(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51442 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51442(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51445 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51445(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51452 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51452(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51453 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51453(reader);
}
});
...
var G__51500 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__51501 = s.append(c);
c = G__51500;
s = G__51501;
continue;
}
