...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__53991){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__53997){
...
var vec__54001 = temp__5751__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54001,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54001,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__54006 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54006,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__54006;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__54011){
...
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54012__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__54017){
var map__54018 = p__54017;
var map__54018__$1 = (((((!((map__54018 == null))))?(((((map__54018.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54018.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54018):map__54018);
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54018__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
...
var vec__54026 = cljs.core.first(rem);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54026,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54026,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,(function (p1__54016_SHARP_){
var G__54029 = p1__54016_SHARP_;
var G__54030 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__54029,G__54030) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__54029,G__54030));
}));
} else {
