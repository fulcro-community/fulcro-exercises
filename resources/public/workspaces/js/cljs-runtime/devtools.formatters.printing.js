...
var len__4736__auto___48931 = arguments.length;
var i__4737__auto___48932 = (0);
while(true){
if((i__4737__auto___48932 < len__4736__auto___48931)){
args__4742__auto__.push((arguments[i__4737__auto___48932]));

var G__48933 = (i__4737__auto___48932 + (1));
i__4737__auto___48932 = G__48933;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq48892){
var G__48893 = cljs.core.first(seq48892);
var seq48892__$1 = cljs.core.next(seq48892);
var G__48894 = cljs.core.first(seq48892__$1);
var seq48892__$2 = cljs.core.next(seq48892__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48893,G__48894,seq48892__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__48909_SHARP_){
return (!((cljs.core.meta(p1__48909_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48912__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e48916){var _e__47959__auto__ = e48916;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e48918){var _e__47959__auto__ = e48918;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__48920 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__48921 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__48921);

try{var map__48922 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48922__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__48920);
}});
...
var temp__5751__auto___48987 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___48987)){
var managed_print_level_48990 = temp__5751__auto___48987;
var _STAR_print_level_STAR__orig_val__48928_48991 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__48929_48992 = managed_print_level_48990;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__48929_48992);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__48927_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__48927_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__48928_48991);
}} else {
job_fn();
}
